  ...
  describe('<%= humanizedPluralName %> Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        var createstate,
          <%= humanizedPluralName %>AdminController,
          mock<%= classifiedSingularName %>;

        beforeEach(inject(function ($controller, $state, $templateCache) {
          createstate = $state.get('admin.<%= slugifiedPluralName %>.create');
          $templateCache.put('/modules/<%= slugifiedPluralName %>/client/views/admin/form-<%= camelizedSingularName %>.client.view.html', '');
        ...
        it('should attach an <%= camelizedSingularName %> to the controller scope', function () {
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('/modules/<%= slugifiedPluralName %>/client/views/admin/form-<%= camelizedSingularName %>.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('/modules/<%= slugifiedPluralName %>/client/views/admin/form-<%= camelizedSingularName %>.client.view.html');
        });
