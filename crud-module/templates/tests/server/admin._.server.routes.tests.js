...
var should = require('should'),
  ...
  <%= humanizedSingularName %> = mongoose.model('<%= humanizedSingularName %>'),
...
describe('<%= humanizedSingularName %> Admin CRUD tests', function () {
          ...
          .end(function (<%= camelizedSingularName %>SaveErr, <%= camelizedSingularName %>SaveRes) {
            ...
            agent.get('/api/<%=camelizedPluralName %>')
              .end(function (<%=camelizedPluralName %>GetErr, <%=camelizedPluralName %>GetRes) {
                ...
                (<%=camelizedPluralName %>[0].title).should.match('<%= humanizedSingularName %> Title');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/<%=camelizedPluralName %>')
          ...
          .end(function (<%= camelizedSingularName %>SaveErr, <%= camelizedSingularName %>SaveRes) {
            ...
            // Update <%= camelizedSingularName %> title
            <%= camelizedSingularName %>.title = 'WHY YOU GOTTA BE SO MEAN?';
            ...
            agent.put('/api/<%=camelizedPluralName %>/' + <%= camelizedSingularName %>SaveRes.body._id)
              ...
              .end(function (<%= camelizedSingularName %>UpdateErr, <%= camelizedSingularName %>UpdateRes) {
                ...
                (<%= camelizedSingularName %>UpdateRes.body.title).should.match('WHY YOU GOTTA BE SO MEAN?');
  ...
  it('should not be able to save an <%= camelizedSingularName %> if no title is provided', function (done) {
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/<%=camelizedPluralName %>')
          ...
          .end(function (<%= camelizedSingularName %>SaveErr, <%= camelizedSingularName %>SaveRes) {
            ...
            (<%= camelizedSingularName %>SaveRes.body.message).should.match('Title cannot be blank');
